...
public class TechnicalCategoryActivity extends AppCompatActivity {
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        int headerBgRes = getIntent().getIntExtra("header_bg", R.drawable.bg_category_technical_detail);
        ...
        if (quizCount != null) tvQuizCount.setText(quizCount + " Quizzes");
        headerBg.setBackgroundResource(headerBgRes);

        final String categoryTitle = title != null ? title : "Technical";
        
        // Dynamic Quiz Count
        int count = com.simats.prepace.utils.QuizDataManager.getQuizzesForCategory(this, categoryTitle).size();
